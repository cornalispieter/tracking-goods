  ...
  try {
    ...
    await html5QrCode.start(
      ...
      (decodedText) => {
        ...
        // Scanner tetap jalan sampai user stop atau lock code
      },
      () => {}
    );
  } catch (err) {
